...
class Location {
   ...
   *  return value: void
   * 
   *  initializes iteration capability
   */
  void start() {  // const
    nextDirection = 0;
  }
   ...
   * 
   *  creates copy of current Location object
   *  modifies the copy so it represents a different location
   *  advances iterator state
   *  returns neighbor it created
   */
   ...
   * 
   *  compares two Location objects on row and col
   */
  ...
  /* isEqual
   *  parameters:
   *      loc -- a Location to compare row and col values to
   *  return value: boolean
   * 
   ...
   *  return value: void
   * 
   *  prints row and col of Location object
   */
  void streamOut() {
  ...
  /* streamIn
   *  parameters:
   *      input -- input taken from Scanner
   *  return value: void
   * 
   *  sets row and col of Location object to scanner input
   */
